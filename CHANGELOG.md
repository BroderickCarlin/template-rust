...
## [0.2.0](https://github.com/BroderickCarlin/template-rust/compare/v0.1.0...v0.2.0) - 2026-02-08
...
- *(Dependabot)* Update tinybmp requirement from 0.6 to 0.7
- *(Dependabot)* Update embedded-graphics-simulator requirement
- *(Dependabot)* Update tinybmp requirement from 0.5 to 0.6
